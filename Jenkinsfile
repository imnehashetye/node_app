        ...
        stage('Deploy'){
            ...
            steps{
                script {
                    ...
                    sh 'ssh ubuntu@10.0.1.56 if [$(ssh ubuntu@10.0.1.56 sudo docker ps -q)  -gt 0];then ssh ubuntu@10.0.1.56 sudo docker kill $(ssh ubuntu@10.0.1.56 sudo docker ps -q); else echo "This no container."; fi'
