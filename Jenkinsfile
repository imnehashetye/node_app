        ...
        stage('Deploy'){
            ...
            steps{
                script {
                    ...
                    sh '[ "$(ssh ubuntu@10.0.1.56 sudo docker ps -a | grep 022536480424.dkr.ecr.us-east-1.amazonaws.com/node_app:latest)" ] && ssh ubuntu@10.0.1.56 sudo docker kill $(ssh ubuntu@10.0.1.56 sudo docker ps -q)'
