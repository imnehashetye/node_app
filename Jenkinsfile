        ...
        stage('Deploy'){
            ...
            steps{
                script {
                    ...
                    sh 'ssh ubuntu@10.0.1.56 if [ $(ssh ubuntu@10.0.1.56 sudo docker ps -q) ssh ubuntu@10.0.1.56 -gt 0 ]; ssh ubuntu@10.0.1.56 sudo docker kill $(ssh ubuntu@10.0.1.56 sudo docker ps -q); fi'
